...
namespace ImGui
{
    ...
    IMGUI_API bool          SetDragDropPayload(const char* type, void *data, size_t sz, ImGuiCond cond = 0, bool copy=true);  // type is a user defined string of maximum 32 characters. Strings starting with '_' are reserved for dear imgui internal types. Data is copied and held by imgui. Return true when payload has been accepted.
